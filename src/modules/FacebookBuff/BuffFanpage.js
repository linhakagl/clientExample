...
export default function BuffFanpage() {
  const typeCode = TypeCode.facebookBuff;
  const targetCode = "order-seeding-like-fanpage";
  const seedingTypes = [{ name: 'Buff Like Fanpage', value: 'buff_like_fanpage' }];
  ...
  return (
    <>
      <PageName text="Buff Like Fanpage" />
